        ...
        <div className='cards'>
            ...
            <div className='cards__container'>
                <div className='cards__wrapper'>
                    ...
                    <ul className='cards__items'>
                        <CardItem src='images/img-3.jpg' text='Coming soon' label='Bigger Project' path='/projects' />
                        <CardItem src='images/img-4.jpg' text='Coming soon' label='Bigger Project' path='/projects' />
                        <CardItem src='images/img-5.jpg' text='Coming soon' label='Bigger Project' path='/projects' />
                    </ul>
